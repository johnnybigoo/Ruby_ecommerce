module Admin::V1
  class ProductsController < ApiController
    ...
    def product_params
      ...
      permitted_params = params.required(:product).permit(:id, :name, :description, :image, :price, :productable,
                                                         :status, category_ids: [])
    ...
    def run_service (product = nil) # In his video this part was below game_params, github below searchable
...
=begin
      ...
      def load_products # in his videos contains this part
